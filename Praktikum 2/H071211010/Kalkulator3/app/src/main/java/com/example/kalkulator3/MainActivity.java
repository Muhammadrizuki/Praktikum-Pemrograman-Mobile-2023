...
import com.example.kalkulator3.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnEqual.setOnClickListener(view -> {
            String regex = Objects.equals(operator, "+") ? "\\+" : operator;
    ...
    private void setValue(Button button) { // button = binding.btn1 setValue(binding.btn1)
